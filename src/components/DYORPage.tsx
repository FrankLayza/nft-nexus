    ...
    return (  
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Do Your Own Research with our AI-powered insights.</p>
            </div>
            <div className="w-full h-fit rounded-lg border border-gray-300 bg-white p-4 shadow-xs">
                <div className="flex flex-col gap-2">
                    <span className="text-2xl font-semibold leading-none tracking-tight">AI Research Assistant</span>
                    <span className="text-sm text-gray-500">Ask questions about NFT projects and market trends</span>
                </div>
                <div className="space-y-4 w-full mt-6">
                    ...
                    <button
                        onClick={async () => {
                            ...
                            setTimeout(() => {
                                setResponse(dummyResponse[Math.floor(Math.random() * dummyResponse.length)]);
